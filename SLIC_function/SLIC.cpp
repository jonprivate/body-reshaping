...
// 			int x2 = min(m_width,	kseedsx[n]+offset);
			int y1 = (0>kseedsy[n]-offset)?0:kseedsy[n]-offset;
			int y2 = (m_height<kseedsy[n]+offset)?m_height:kseedsy[n]+offset;
			int x1 = (0>kseedsx[n]-offset)?0:kseedsx[n]-offset;
			int x2 = (m_width<kseedsx[n]+offset)?m_width:kseedsx[n]+offset;
...
//     dirname(filename.c_str(), NULL, NULL, fname, extn);
// 	string temp = fname;
// 
// 	ofstream outfile;
